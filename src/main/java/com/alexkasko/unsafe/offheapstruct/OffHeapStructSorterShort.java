 ...
 * and adapted to {@link OffHeapStructCollection} with signed short keys.
 *
 ...
 */
class OffHeapStructSorterShort {

    /**
     * Sorts the specified off-heap struct collection into ascending order using signed short struct key.
     *
    ...
    /**
     * Sorts the specified range of the off-heap struct collection into ascending order using signed short struct key.
     ...
     * Dual-Pivot Quicksort algorithm using signed short struct key.
     *
     * @param a the off-heap header-payload collection to be sorted
     * @param left the index of the first element, inclusive, to be sorted
