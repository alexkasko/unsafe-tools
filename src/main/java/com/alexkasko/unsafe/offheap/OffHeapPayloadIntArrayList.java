...
/**
 * Implementation of off-heap header-int_payload array-list of long using {@link com.alexkasko.unsafe.offheap.OffHeapMemory}.
 * Memory block for each index contains {@code long} header anb {@code int} payload.
 * Memory area will be allocated another time and copied on elements adding. This class doesn't support elements removing.
 * {@link #get(long)} and {@link #set(long, long, int)} access operations indexes are checked using {@code assert} keyword
 ...
 * and may be called multiple times) or it will be freed after {@link com.alexkasko.unsafe.offheap.OffHeapLongArray}
...
public class OffHeapPayloadIntArrayList implements OffHeapPayloadIntAddressable, OffHeapDisposable {
     ...
     */
    public OffHeapPayloadIntArrayList(long capacity) {
